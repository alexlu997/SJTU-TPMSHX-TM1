...
def test_real_three_process_handoff(tmp_path, dimension):
    from sjtu_tpmshx.tests.integration_tm1.test_2d_real import AIR_BASELINE_METRICS, AIR_NATIVE_Q
...
'''
    ...
    expected = ([AIR_NATIVE_Q, *AIR_BASELINE_METRICS[1:]] if dimension == 2 else
