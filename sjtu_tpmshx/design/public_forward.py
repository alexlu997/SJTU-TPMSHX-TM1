"""Application-only mapping for the explicit quick-design public mode."""
...
def forward(case, topo, l, t, s, Lx, arrangement='cross', *, init=None,
            k_s=K_STEEL, prop_model='const', tol=LTNE_TOL, height=None):
