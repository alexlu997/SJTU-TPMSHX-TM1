...
当前模型和适用范围见[架构说明](../docs/architecture.md)，运行入口见
[工具导航](../docs/tools.md)。CSV 的成员、数值和失败记录按各工具的原约定保留。
...
| [SIMPLER 比较](simpler-coupling-2d/) | 原算法试验的比较 CSV 与负结果结论 |

已结束的 M1/M2、Shanghai 旧分析和求解效率报告见
